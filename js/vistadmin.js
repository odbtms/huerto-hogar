// Se envuelve todo el código en este evento para asegurar que el HTML se haya cargado completamente.
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Cargar productos desde localStorage o usar un array inicial si no hay nada guardado.
    ...
    document.getElementById("formProducto").addEventListener("submit", function (e) {
        ...
        const nuevoProducto = {
            ...
            categoria: document.getElementById("categoriaProducto").value, // No necesita trim
    ...
    // Inicializar la tabla y las métricas al cargar la página
    renderTabla();
    actualizarMetricas();
}); // <- La llave extra estaba después de esta línea